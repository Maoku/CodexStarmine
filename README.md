...
編集体験の Renewal3 Phase 7 まで実装済みです。菊・牡丹・冠・椰子・千輪・ハートに、柳・蜂・飛遊星・花雷・万華鏡・土星・蝶々・小割を加えた14種を3号・5号・10号で仕立て、3D玉ナビゲーターで選んだ切断面へ仮想星を配置してから、共通の湖面画面で単発確認または自動構成のスターマインを鑑賞できます。
