...
- [ ] `FireworkDesign` v2、仮想星ライブラリ、外周・芯・型物・子花レイヤー
- [ ] 実物の花火制作を思わせる半球の玉皮と、球状の仮想星をつまむ・置く・列へ詰める内部配置UI
- [ ] 半球組立、断面、型物配置、色・方向・タイミングだけの簡易確認の4表示
- [ ] Undo/Redo、構成A/B、描画負荷の警告、制作確定後に初めて完成形を見せる打上導線
- [ ] v1保存作品の非破壊移行と既存6プリセット・フリー鑑賞の回帰確認
...
- **M2.5（Phase 6.5 完了）**: 内部配置を含む花火デザイン体験が成立
...
- **受け入れテスト**: RESEARCH 9.12節と13章をチェックリスト化し、Phase 6.5とPhase 8で全項目を確認する
